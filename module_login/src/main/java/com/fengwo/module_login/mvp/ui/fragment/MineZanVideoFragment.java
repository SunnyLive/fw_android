...
public class MineZanVideoFragment extends BaseListFragment<VideoHomeShortModel> {
    private final static String UID = "uid";
    private final static String ZAN = "iszan";

    public static MineZanVideoFragment newInstance(int uid, boolean b) {

        Bundle args = new Bundle();
        args.putInt(UID, uid);
        args.putBoolean(ZAN, b);
        MineZanVideoFragment fragment = new MineZanVideoFragment();
