...
public class HuafenTaskAdapter extends BaseQuickAdapter<TaskDto, BaseViewHolder> {

    public HuafenTaskAdapter(@Nullable List<TaskDto> data) {
        super(R.layout.login_item_huafen_task, data);
    }
