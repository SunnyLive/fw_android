...
import com.faceunity.ui.beautybox.BaseBeautyBox;
...
import static com.faceunity.ui.entity.BeautyParameterModel.STR_FILTER_LEVEL;
import static com.faceunity.ui.entity.BeautyParameterModel.getValue;
import static com.faceunity.ui.entity.BeautyParameterModel.isOpen;
import static com.faceunity.ui.entity.BeautyParameterModel.sFilter;
import static com.faceunity.ui.entity.BeautyParameterModel.sFilterLevel;
import static com.faceunity.ui.entity.BeautyParameterModel.sSkinDetect;
import static com.faceunity.ui.entity.BeautyParameterModel.setValue;
...
//                ToastUtil.showNormalToast(mContext, desc);
    ...
    private void onChangeFaceBeautyLevel(int viewId) {
        ...
        } else if (viewId == R.id.rb_blur_clear || viewId == R.id.rb_blur_fine || viewId == R.id.rb_blur_hazy) {
    ...
    private void clickViewBottomRadio(int viewId) {
        ...
        if (viewId == R.id.beauty_radio_skin_beauty) {
            ...
            seekToSeekBar(id);
            mRgBlurType.setVisibility(INVISIBLE);
            mTvRecoverFaceShape.setVisibility(VISIBLE);
