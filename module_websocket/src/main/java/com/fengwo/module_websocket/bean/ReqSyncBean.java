...
public class ReqSyncBean {
    public static String build(int userId,String msgId,String vendor){
        ReqSyncBean reqSyncBean = new ReqSyncBean();
        reqSyncBean.toUid = "-1";
        reqSyncBean.msgId = msgId;
        reqSyncBean.version = "2.0";
        reqSyncBean.vendor = vendor;
    ...
    public static String buildPing(int userId,String msgId,String vendor){
        ReqSyncBean reqSyncBean = new ReqSyncBean();
        reqSyncBean.toUid = "-1";
        reqSyncBean.msgId = msgId;
        reqSyncBean.version = "2.0";
        reqSyncBean.vendor = vendor;
        reqSyncBean.description = "笑死人了";
        reqSyncBean.timestamp = System.currentTimeMillis() + "";
        reqSyncBean.busiEvent = "ping";
        DataBean dataBean = new DataBean();
        dataBean.setUserId(String.valueOf(userId));
        dataBean.setAction("sync");
        reqSyncBean.setData(dataBean);
