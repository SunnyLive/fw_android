 ...
 * @date 2019/12/30
 */
public class ShortVideoCommentAdapter extends BaseQuickAdapter<ShortVideoCommentDto, ShortVideoCommentViewHolder> {
    ...
    @Override
    protected void convert(@NonNull ShortVideoCommentViewHolder helper, ShortVideoCommentDto item) {
    ...
    public interface OnChildItemClickListener {
        void commentLike(int parentPosition, int position, ShortVideoCommentDto commentModel);

        void commentClick(int parentPosition, int position, ShortVideoCommentDto commentModel);
    }
}
