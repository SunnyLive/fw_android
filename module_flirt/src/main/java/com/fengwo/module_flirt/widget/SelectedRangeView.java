...
public class SelectedRangeView extends View {
    ...
    private void initAttrs(Context context, @Nullable AttributeSet attrs) {
        ...
        progressColor = typedArray.getColor(R.styleable.view_selected_range_progressColor,getResources().getColor(R.color.gray_EEEEEE));
        selectedColor = typedArray.getColor(R.styleable.view_selected_range_selectedColor,getResources().getColor(R.color.purple_9966ff));
        circleCorlor = typedArray.getColor(R.styleable.view_selected_range_circleCorlor,getResources().getColor(R.color.text_white));
        circleShadowCorlor = typedArray.getColor(R.styleable.view_selected_range_circleShadowCorlor,getResources().getColor(R.color.gray_DDDDDD));
        ShadowWidth = typedArray.getDimension(R.styleable.view_selected_range_shadowWidth,10f);
...
//    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (BcircleValue != 0) {//设置B圆 初始值
            BcircleX = circleRadius*3 + BcircleValue * distance;
        }else {//默认最大值
