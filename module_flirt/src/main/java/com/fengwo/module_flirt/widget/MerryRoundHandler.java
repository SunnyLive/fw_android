...
public abstract class MerryRoundHandler extends Handler {
    //消息what
    ...
    //旋转方向
    private MerryRoundDirection mRotateDirection;

    public MerryRoundHandler(boolean isAutoRotation, int mRotationTime , int mRotateDirection) {
        this.isAutoRotation = isAutoRotation;
        this.mRotationTime = mRotationTime;
        this.mRotateDirection=mRotateDirection==0? MerryRoundDirection.clockwise: MerryRoundDirection.anticlockwise;
     ...
     * 需要旋转通知方法
     */
    public abstract void onRotating(MerryRoundDirection mRotateDirection);
     ...
     * @return
     */
    public MerryRoundDirection getmRotateDirection() {
     ...
     */
    public void setmRotateDirection(MerryRoundDirection mRotateDirection) {
