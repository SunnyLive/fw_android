...
public class PraiseListFragment extends BaseListFragment<InteractBean> {
    ...
    public Flowable setNetObservable() {
        ...
        return new RetrofitUtils().createApi(ChatService.class).getCardLikeList(p);
    }
    ...
    public int setItemLayoutRes() {
        return R.layout.item_praise_list;
    }
...
//            SelectCommonDialogWindow dialog = new SelectCommonDialogWindow(getActivity(), true, "", "删除此条点赞", "");
