package com.fengwo.module_flirt.UI.certification.adapter;
...
public class FlirtCerAdapter extends RecyclerView.Adapter {
    ...
    public FlirtCerAdapter(Context context) {
