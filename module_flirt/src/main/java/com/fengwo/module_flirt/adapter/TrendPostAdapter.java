...
public class TrendPostAdapter extends RecyclerView.Adapter {

    public static final int MAX_COUNT_IMAGE = 4;
    ...
    public TrendPostAdapter(Context context) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        switch (viewType) {
            case TYPE_POST:
                view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_trend_post, parent, false);
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        switch (getItemViewType(position)) {
            case TYPE_CARD:
                ...
                PostCardItem p = data.get(position);
                File itemFile = new File(p.filePath);
                cardHolder.mIvPlay.setVisibility(p.isVideo ? View.VISIBLE : View.GONE);
    ...
    private class ContentViewHolder extends RecyclerView.ViewHolder {
        ...
        private final TextView mTvVideoTip;
        ...
        ContentViewHolder(@NonNull View itemView) {
            ...
            mIvPlay = itemView.findViewById(R.id.iv_card_play_item);
            mTvVideoTip = itemView.findViewById(R.id.iv_card_video_tip);
            itemView.findViewById(R.id.iv_card_video).setVisibility(View.GONE);
            ivDelete.setVisibility(View.VISIBLE);
            ivDelete.setOnClickListener(v -> {
                int position = getLayoutPosition();
                deleteDataItem(position);
                if (listener != null) {
                    listener.itemDel(position);
                    if (isVideo) {
                        post = null;
                    }
                }
            ...
            if (isVideo) {
                ...
                mTvVideoTip.setVisibility(View.GONE);
            }
        }
    }
