...
public class BrowserActActivity extends BaseMvpActivity implements View.OnClickListener {
    ...
    public static void start(Context context, String title, String url) {
        Intent intent = new Intent(context, BrowserActActivity.class);
        intent.putExtra("title", title);
        intent.putExtra("url", url);
        context.startActivity(intent);
    }
    public static void start(Context context, String title, String url, String isSHare) {
        Intent intent = new Intent(context, BrowserActActivity.class);
        intent.putExtra("title", title);
        intent.putExtra("url", url);
    ...
    public static void startRuleActivity(Context context) {
        Intent i = new Intent(context, BrowserActActivity.class);
   ...
   private String isSHare  = "0";
    ...
    protected void initView() {
        ...
        if(null!=intent.getStringExtra("isSHare")){
...
//        });
        ...
        if (title.equals("雪夜古堡大作战") || title.equals("万圣节")||isSHare.equals("1")) {
            new ToolBarBuilder().showBack(true)
                    .setTitle(title)
                    .setTitleColor(R.color.text_33)
                    .setBackIcon(R.drawable.ic_back_black)
                    .setRight1Img(R.mipmap.pic_share_w, this)
                    .build();
        } else {
            new ToolBarBuilder().showBack(true)
                    .setTitle(title)
...
//        settings.setTextZoom(150);
    ...
    public void onClick(View view) {
        if (view.getId() == R.id.right1_img) {
            new SharePopwindow(this, 0, false).showPopupWindow();
        }
    }
...
//            }
            if (MapUtil.isGdMapInstalled()) {
                MapUtil.goToGaodeMap(BrowserActActivity.this, Double.parseDouble(latitude), Double.parseDouble(longitude), add);
                return;
            }
            if (MapUtil.isBaiduMapInstalled()) {
                MapUtil.goToBaiduMap(BrowserActActivity.this, Double.parseDouble(latitude), Double.parseDouble(longitude), add);
                return;
            }
            if (MapUtil.isTencentMapInstalled()) {
                MapUtil.goToTencentMap(BrowserActActivity.this, Double.parseDouble(latitude), Double.parseDouble(longitude), add);
                return;
            }
