...
public class RadarProgressView extends RelativeLayout {
    ...
    private static final float DEFAULT_SCALE_RATE=1.5f;
    ...
    private void init(final Context context, final AttributeSet attrs) {
        ...
        scale_rate=typedArray.getFloat(R.styleable.RippleBackground_rb_scale_rate,DEFAULT_SCALE_RATE);
        ...
        rippleParams=new LayoutParams((int)(scale_rate*(rippleRadius+rippleStrokeWidth)),(int)(scale_rate*(rippleRadius+rippleStrokeWidth)));
