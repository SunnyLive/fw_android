...
public abstract class BaseNiceDialog extends DialogFragment {
    ...
    @StyleRes
    protected int theme = R.style.Theme_AppCompat_Dialog; // dialog主题
    @StyleRes
    ...
    private void initParams() {
        ...
        if (window != null) {
            ...
            //设置dialog宽度
            if (width == 0) {
                lp.width = ScreenUtils.getScreenWidth(getActivity()) - 2 * DensityUtils.dp2px(getActivity(),margin);
            } else if (width == -1) {
                lp.width = WindowManager.LayoutParams.WRAP_CONTENT;
            } else {
                lp.width = DensityUtils.dp2px(getActivity(),width);
            }
            ...
            if (height == 0) {
                ...
                lp.height = DensityUtils.dp2px(getActivity(),height);
            }
