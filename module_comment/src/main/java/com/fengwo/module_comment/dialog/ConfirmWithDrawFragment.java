 ...
 */
public class ConfirmWithDrawFragment extends BaseDialogFragment {
     ...
     * @return
     */
    public static ConfirmWithDrawFragment newInstance(@NonNull String title, @NonNull OnClickListener onClickListener) {
        ConfirmWithDrawFragment fragment = new ConfirmWithDrawFragment();
    ...
    public static ConfirmWithDrawFragment newInstance(@NonNull String title, @NonNull String confirmText,
     ...
     * @return
     */
    public static ConfirmWithDrawFragment newInstance(@NonNull String title,boolean tip, @NonNull OnClickListener onClickListener) {
        ConfirmWithDrawFragment fragment = new ConfirmWithDrawFragment();
        fragment.mOnClickListener = onClickListener;
        Bundle bundle = new Bundle();
        bundle.putString(TITLE, title);
        bundle.putBoolean(TIP, tip);
        fragment.setArguments(bundle);
        return fragment;
    }
    ...
    protected View createDialogView(LayoutInflater inflater, @Nullable ViewGroup container) {
        View view = inflater.inflate(R.layout.dialog_withdraw_confirm, container, false);
        ...
        TextView tvConfirm = view.findViewById(R.id.tv_sure);
        ...
        boolean tip = getArguments().getBoolean(TIP);
        TextView tvOk = view.findViewById(R.id.tv_ok);
        tvOk.setOnClickListener(onClickListener);
        tvOk.setVisibility(tip?View.VISIBLE:View.GONE);
        tvCancel.setVisibility(tip?View.GONE:View.VISIBLE);
        tvConfirm.setVisibility(tip?View.GONE:View.VISIBLE);
        return view;
    }
