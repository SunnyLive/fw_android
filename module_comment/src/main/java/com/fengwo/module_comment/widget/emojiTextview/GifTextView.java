package com.fengwo.module_comment.widget.emojiTextview;
...
import com.fengwo.module_comment.utils.GifOpenHelper;
    ...
    public boolean parseMessage(GifTextView gifTextView) {
        if (gifTextView.myText != null && !gifTextView.myText.equals("")) {
            ...
            for (int i = 0; i < gifTextView.spanInfoList.size(); i++) { // for循环，处理显示多个图片的问题
             ...
             //   int size =  getContext().getResources().getDimension(R.dimen.sp_15);
                if (gifCount != 0) {
