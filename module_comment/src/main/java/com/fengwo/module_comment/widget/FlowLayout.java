...
public class FlowLayout extends LinearLayout {
    ...
    private final static class Type {
        ...
        Type(Context context, AttributeSet attrs) {
            ...
            grivate = typedArray.getInt(R.styleable.FlowLayout_grivate, grivate);
            horizontal_Space = typedArray.getDimension(R.styleable.FlowLayout_horizontal_Space, horizontal_Space);
            vertical_Space = typedArray.getDimension(R.styleable.FlowLayout_vertical_Space, vertical_Space);
            isFull = typedArray.getBoolean(R.styleable.FlowLayout_isFull, isFull);
        }
    }
