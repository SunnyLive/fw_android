...
public class ViewPagerIndicator extends View {
        ...
        switch (mIndicatorType) {
            ...
            case IndicatorType.CIRCLE_LINE://圆线
                ...
                if (mPosition == mNum - 1) {//最后一个 右滑
                    ...
                    paintStroke.setColor(mSelected_color);
    ...
    public void setRadiusSelected(float mRadiusSelected) {
        this.mRadiusSelected = mRadiusSelected;
    }
    ...
    public void setSelectedColor(int mSelected_color) {
        this.mSelected_color = mSelected_color;
    }

    public void setDefaultColor(int mDefault_color) {
        this.mDefault_color = mDefault_color;
    }

    public void setAnimation(boolean mAnimation) {
