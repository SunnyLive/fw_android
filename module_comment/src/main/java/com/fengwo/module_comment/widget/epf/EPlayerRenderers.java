...
import com.fengwo.module_comment.widget.epf.filter.GlLookUpTableFilter;
import com.fengwo.module_comment.widget.epf.filter.GlPreviewFilter;
...
public class EPlayerRenderers extends EFrameBufferObjectRenderers implements SurfaceTexture.OnFrameAvailableListener {

    private static final String TAG = EPlayerRenderers.class.getSimpleName();

    private ESurfaceTextures previewTexture;
    ...
    private final EPlayTextureView glPreview;

    private float aspectRatio = 1f;

    private SimpleExoPlayer simpleExoPlayer;

   public EPlayerRenderers(EPlayTextureView glPreview) {
        super();
    ...
    public void onSurfaceCreated(final EGLConfig config) {
        ...
        previewTexture = new ESurfaceTextures(texName);
