...
import com.fengwo.module_comment.widget.floatingview.utils.SystemUtils;
...
//        updateSize();
    ...
    protected void dealClickEvent() {
        if (mMagnetViewListener != null) {
            ...
            FloatingView.getInstance().startChatRoomActivity();
        }
    }
...
//        mScreenHeight = SystemUtils.getScreenHeight(getContext());
    ...
    public void onRemove() {
        if (mMagnetViewListener != null) {
            ...
            ExitWindowEvent event = new ExitWindowEvent();
