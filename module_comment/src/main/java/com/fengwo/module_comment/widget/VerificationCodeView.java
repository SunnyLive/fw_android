...
/**
 * https://github.com/jiaoyaning/VerificationCodeView
 * jiaoyaning
...
public class VerificationCodeView extends LinearLayout implements TextWatcher, View.OnKeyListener, View.OnFocusChangeListener {
    ...
    public VerificationCodeView(Context context, AttributeSet attrs) {
        ...
        mEtTextSize = typedArray.getDimensionPixelSize(R.styleable.vericationCodeView_vcv_et_text_size, (int) getResources().getDimension(R.dimen.sp_16));
        mEtTextBg = typedArray.getResourceId(R.styleable.vericationCodeView_vcv_et_bg, R.drawable.bg_verificattion_code_view_default);
        mCursorDrawable = typedArray.getResourceId(R.styleable.vericationCodeView_vcv_et_cursor, R.drawable.bg_verificattion_code_view_default_cursor);
        mEtTextBgFocus = typedArray.getResourceId(R.styleable.vericationCodeView_vcv_et_bg_focus, R.drawable.bg_verificattion_code_view_default_focus);
    ...
    private void focus() {
        ...
        for (int i = 0; i < count; i++) {
            ...
            if (editText.getText().length() < 1) {
                ...
                editText.setBackgroundResource(mEtTextBgFocus);
                editText.setCursorVisible(false);
                if (i == count - 1) {
                    editText.requestFocus();
                    KeyBoardUtils.openKeybord(editText, getContext());
