package com.fengwo.module_comment.widget.likeview;
...
public class KsgLikeView extends RelativeLayout {
    ...
    private int[] res = {R.drawable.live_paopao01, R.drawable.live_paopao02, R.drawable.live_paopao03, R.drawable.live_paopao04, R.drawable.live_paopao05, R.drawable.live_paopao06, R.drawable.live_paopao07};
    ...
    private void init(int defaultFavor, int enterDuration, int curveDuration) {
        ...
        if (defaultFavor == -1) {
            ...
            defaultFavor = R.drawable.live_paopao01;

            L.e(TAG, "please pass in the default image resource !");
        }
        ...
        // 获取图片的宽高
        int picWidth = (int) (drawable.getIntrinsicWidth() * 0.8);
        int picHeight = (int) (drawable.getIntrinsicHeight() * 0.8);
    ...
    public void addFavor() {
        ...
        int position = Math.abs(mPathAnimator.mRandom.nextInt(res.length));
        L.e("qipao", position + "");
        favor.setImageResource(res[position]);
