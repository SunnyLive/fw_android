 ...
 * 版    本：1.0
 * 创建日期：2018/11/15.
 * 描    述：表情加载类,可自己添加多种表情，分别建立不同的map存放和不同的标志符即可
 * 修订历史：
 * ================================================
 */
public class EmotionUtils {
     ...
     * value-表情图片资源
     */
    public static LinkedHashMap<String, Integer> EMPTY_GIF_MAP;//gif动态图
    public static LinkedHashMap<String, Integer> EMOTION_STATIC_MAP;//静态表情
    ...
    public static SpannableString getEmotionContent(final Context context, final TextView tv, String source) {
        ...
        while (matcherEmotion.find()) {
            ...
            if (imgRes != null) {
                // 压缩表情图片
                int size = (int) tv.getTextSize() * 12 / 8;
