...
public class ChatEmotionFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_chat_emotion,null);
        return view;
    }
...
// 创建GridView
    ...
    public void onViewCreated(View v, @Nullable Bundle savedInstanceState) {
        ...
        fragmentChatVp = v.findViewById(R.id.fragment_chat_vp);
        fragmentChatGroup = v.findViewById(R.id.fragment_chat_group);
        initWidget();
    }
