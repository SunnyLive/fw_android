...
public class MapUtil {
    ...
    public static void goToTencentMap(Context context, double lat, double lng, String mAddressStr) {
        StringBuffer stringBuffer = new StringBuffer("qqmap://map/routeplan?type=drive")
                .append("&tocoord=").append(lat).append(",").append(lng).append("&to=" + mAddressStr);
     ...
     * 跳转高德地图
     */
    public static void goToGaodeMap(Context context, double lat, double lon, String mAddressStr) {
        StringBuffer stringBuffer = new StringBuffer("androidamap://navi?sourceApplication=").append("amap");
        stringBuffer.append("&lat=").append(lat)
                .append("&lon=").append(lon).append("&keywords=" + mAddressStr)
                .append("&dev=").append(0)
