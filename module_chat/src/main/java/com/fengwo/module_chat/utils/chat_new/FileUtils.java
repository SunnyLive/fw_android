...
public class FileUtils {
    ...
    static {
        ...
        STORAGE_BASE_DIR = BaseApplication.mApp.getFilesDir().getAbsolutePath() + "/" + STORAGE_EXTERNAL_PATH;
...
//        return file.getAbsolutePath()+"/";
    ...
    public static boolean deleteFile(String fileName) {
        ...
        if (file.exists() && file.isFile()) {
            if (file.delete()) {
                L.e(TAG, "删除单个文件" + fileName + "成功！");
                return true;
            } else {
                L.e(TAG, "删除单个文件" + fileName + "失败！");
                return false;
            }
        } else {
            L.e(TAG, "删除单个文件失败：" + fileName + "不存在！");
            return false;
        }
    }
    ...
    public static String getFromAssetsByFileName(String fileName) {
        ...
        try {
            inputReader = new InputStreamReader(BaseApplication.mApp.getResources().getAssets().open(fileName));
