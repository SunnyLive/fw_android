package com.fengwo.module_chat.widgets.indexbar.suspension;
...
public class SuspensionDecoration extends RecyclerView.ItemDecoration {
    ...
    private static int COLOR_TITLE_BG = Color.parseColor("#f6f6f6");
    ...
    public SuspensionDecoration(Context context, List<? extends ISuspensionInterface> datas) {
        ...
        mTitleMarginLeft = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 12, context.getResources().getDisplayMetrics());
...
/*
        ...
        c.drawText(mDatas.get(position).getSuspensionTag(), mTitleMarginLeft, child.getTop() - params.topMargin - (mTitleHeight / 2 - mBounds.height() / 2), mPaint);
    }
    ...
    public void onDrawOver(Canvas c, final RecyclerView parent, RecyclerView.State state) {//最后调用 绘制在最上层
        ...
        c.drawText(tag, mTitleMarginLeft,
