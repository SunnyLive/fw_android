...
import com.fengwo.module_chat.widgets.xbanner.entity.SimpleBannerInfo;
import com.fengwo.module_chat.widgets.xbanner.transformers.BasePageTransformer;
import com.fengwo.module_chat.widgets.xbanner.transformers.Transformer;
...
public class XBanner extends RelativeLayout implements XBannerViewPager.AutoPlayDelegate, ViewPager.OnPageChangeListener {
    ...
    private void initCustomAttrs(Context context, AttributeSet attrs) {
        ...
        if (typedArray != null) {
            ...
            mPointNoraml = typedArray.getResourceId(R.styleable.XBanner_pointNormal, R.drawable.oval_grayf6);
            mPointSelected = typedArray.getResourceId(R.styleable.XBanner_pointSelect, R.drawable.xbanner_shape_point_select);
    ...
    private void initView() {
        ...
        if (mIsClipChildrenMode) {
            mPointContainerLp.setMargins(mClipChildrenLeftRightMargin, 0, mClipChildrenLeftRightMargin, 0);
        }
...
//            }
            ...
            layoutParams.setMargins(mClipChildrenLeftRightMargin, mClipChildrenTopBottomMargin, mClipChildrenLeftRightMargin,  0);
        ...
        if (mIsAutoPlay && !mIsOneImg & mViewPager != null) {
            switch (ev.getAction()) {
                case MotionEvent.ACTION_DOWN:
                    ...
                    if (touchX >= paddingLeft && touchX < ScreenUtils.getScreenWidth(getContext()) - paddingLeft) {
                        stopAutoPlay();
                    }
                    break;
