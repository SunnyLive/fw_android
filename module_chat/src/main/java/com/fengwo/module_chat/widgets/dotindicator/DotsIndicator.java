...
///**
// * 已修改
// * 使用此指示器viewpager 的adapter.getCount 必须 >= 3
// */
...
//            });
//        } else {
//            L.e(DotsIndicator.class.getSimpleName(), "You have to set an adapter to the view pager before !");
//        }
//    }
//
//
...
//        if (dots.size() < mDotCount) {
//            addDots(mDotCount - dots.size());
//        } else if (dots.size() > mDotCount) {
//            removeDots(dots.size() - mDotCount);
//        }
//    }
//
...
//            } else {
//                background.setColor(getRealPosition() == i ? selectedDotColor : dotsColor);
//            }
...
//        if (viewPager != null && viewPager.getAdapter() != null && mDotCount > 0) {
...
//            onPageChangeListenerHelper.onPageScrolled(getRealPosition(), -1, 0f);
//        }
//    }
//
//    private OnPageChangeListenerHelper buildOnPageChangedListener() {
//        return new OnPageChangeListenerHelper(viewPager.getAdapter().getCount()) {
//            @Override
...
//
//                        if (progressMode && selectedPosition <= getRealPosition()) {
...
//
//            if (i == getRealPosition() || (progressMode && i < getRealPosition())) {
...
//    /**
//     *
//     * 等于1的话就返回1 banner大于1就返回一个相对真实的位置用于轮播
//     *
//     * @return
//     */
//    private int getRealPosition() {
//        int pageSize = viewPager.getAdapter().getCount();
//        if (pageSize >= 4) {//如果大于1基本就加了假数据，至少大于等于四
//            int position = viewPager.getCurrentItem();
//            if (position == 0){
//                return pageSize-1;
//            }else if(position == pageSize-1)return 1;
...
//            return;
//        }
//        for (int i = 0; i < getRealPosition(); i++) {
